        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <p className="text-muted-foreground text-lg mb-4">
              Fort depuis plus de 20 ans d'expérience dans le domaine du bâtiment, les associés <span className="font-bold text-foreground">Fatih</span> (plombier - chauffagiste) et <span className="font-bold text-foreground">Mukremin KOCAK</span> (maçon - charpentier) ont décidé de mettre en commun avec <span className="font-bold text-foreground">KF Services</span> leurs compétences, afin de répondre aux besoins et exigences des clients particuliers et professionnels.
            </p>

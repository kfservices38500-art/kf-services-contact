        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          duration: 0.7
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-6">
              {deptFilter ? <>Nos réalisations en <span className="gradient-red-text">{deptNames[deptFilter] || deptFilter} ({deptFilter})</span></> : <>Pas des promesses, <span className="gradient-red-text">des résultats concrets</span></>}
            </h1>
